            ...
            <table className="w-full" data-testid="po-table">
              ...
              <tbody>
                {loading ? (
                  ...
                  <tr><td colSpan={14} className="px-4 py-8 text-center text-slate-500">No purchase orders found</td></tr>
              ...
              {viewDialog.po?.items?.length > 0 ? (
                <div className="border border-slate-200 rounded-lg overflow-hidden">
                  <table className="w-full text-sm">
                    ...
                    <tfoot className="bg-slate-50 border-t-2 border-slate-200">
                      <tr>
                        <td colSpan="6" className="px-3 py-3 text-right font-medium text-slate-900">Total:</td>
